...
public class AtomClientFactory {
    public AtomFeedClient create(MarkerDataSource markerDataSource, AllFailedEvents allFailedEvents){
        return new AtomFeedClient(new AllFeeds(new WebClient()), new AllMarkers(markerDataSource), allFailedEvents);
    }
}
