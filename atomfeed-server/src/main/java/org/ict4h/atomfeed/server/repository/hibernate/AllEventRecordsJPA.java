package org.ict4h.atomfeed.server.repository.hibernate;
...
public class AllEventRecordsJPA implements AllEventRecords {
    ...
    /* (non-Javadoc)
	 * @see org.ict4h.atomfeed.server.repository.AllEventRecords#add(org.ict4h.atomfeed.server.domain.EventRecord)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see org.ict4h.atomfeed.server.repository.AllEventRecords#get(java.lang.String)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see org.ict4h.atomfeed.server.repository.AllEventRecords#getTotalCount()
	 */
    @Override
