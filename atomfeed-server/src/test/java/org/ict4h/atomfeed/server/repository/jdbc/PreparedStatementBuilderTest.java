...
public class PreparedStatementBuilderTest {
    ...
    public void shouldBuildCountQueryWithNoCriterion() throws Exception {
        final String rawSql = PreparedStatementBuilder.count().withCriteria(new EmptyCriterion()).getRawSql();
    ...
    public void shouldBuildCountQueryWithCategoryTitleCriterion() throws Exception {
        ...
        final String rawSql = PreparedStatementBuilder.count().withCriteria(criterion).getRawSql();
    ...
    public void shouldBuildCountPreparedStatementWithNoCriterion() throws Exception {
        ...
        PreparedStatementBuilder.count().withCriteria(new EmptyCriterion()).build(connection);
    ...
    public void shouldBuildCountPreparedStatementWithCriterion() throws Exception {
        ...
        PreparedStatementBuilder.count().withCriteria(new TitleCriteria("title")).build(connection);
        verify(statement).setString(1,"title");
    }

    @Test
    public void shouldBuildSelectQueryWithNoCriterion() throws Exception {
        final String rawSql = PreparedStatementBuilder.select().withCriteria(new EmptyCriterion()).getRawSql();
    ...
    public void shouldBuildSelectQueryWithOrderAndNoCriterion() throws Exception {
        final String rawSql = PreparedStatementBuilder.select().withCriteria(new EmptyCriterion()).orderById().getRawSql();
